    ...
    <div className="student-portal-shell">
      ...
      >
        ...
        <div className="student-sidebar-brand">
          <Link to="/dashboard" className="student-brand-link" onClick={closeDrawer}>
        ...
        <div className="student-sidebar-user">
          ...
          <div className="student-user-info">
            <h4 className="student-user-name">{user?.name || 'Aarav Sharma'}</h4>
      ...
      <div className="student-main-content">
        ...
        <header className="student-topbar">
          ...
          <div className="student-topbar-right">
            ...
            <NavLink to="/notifications" className="student-icon-action-btn" aria-label="Notifications">
              <Bell size={17} />
              <span className="student-unread-dot" />
            </NavLink>

            <NavLink to="/profile" className="student-icon-action-btn" aria-label="Profile">
              <User size={17} />
            </NavLink>
