  ...
  return (
    <section className="section">
      <div className="container-page">
        <p className="font-bold text-brand-600">CAREERS</p>
        <h1 className="mt-2 section-title">Build the future with us.</h1>
        <p className="section-subtitle">
          Join a team that enjoys solving real problems with technology.
        </p>
        <div className="mt-12 grid gap-5">
          {jobs.map(([title, skills, type]) => (
            <div
              key={title}
            ...
            >
              <div>
                ...
                <p className="mt-2 text-sm text-slate-600">{skills}</p>
              </div>
