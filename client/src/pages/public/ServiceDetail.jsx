  ...
  return (
    <section className="section">
      <div className="container-page max-w-4xl">
        <p className="font-bold text-brand-600">SERVICE</p>
        <h1 className="mt-2 text-4xl font-black">{service.title}</h1>
        <p className="mt-6 text-lg leading-8 text-slate-600">
          {service.description}
        </p>
        {service.content && (
          <div className="mt-10 whitespace-pre-line leading-8 text-slate-700">
            {service.content}
          </div>
        )}
