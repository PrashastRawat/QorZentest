...
export default function Navbar() {
  ...
  const handleDropdownClose = (setState, timeoutRef) => {
    timeoutRef.current = setTimeout(() => {
      setState(false);
    }, 150);
  };

  const handleDropdownEnter = (timeoutRef) => {
        ...
        <div className="flex h-20 items-center justify-between rounded-full border border-slate-800/80 bg-slate-950/85 px-5 shadow-2xl backdrop-blur-xl lg:grid lg:grid-cols-[auto_1fr_auto] lg:px-8">
          ...
          <nav className="hidden items-center justify-center gap-8 lg:flex">
            ...
            >
              ...
              >
                ...
                <ChevronDown
                  size={15}
                  className={`transition duration-200 ${servicesOpen ? "rotate-180 text-brand-400" : ""}`}
                />
              </button>
            ...
            >
              ...
              >
                ...
                <ChevronDown
                  size={15}
                  className={`transition duration-200 ${trainingOpen ? "rotate-180 text-brand-400" : ""}`}
                />
              </button>

              {trainingOpen && (
                <div
                  className="absolute left-1/2 top-full mt-2 w-48 -translate-x-1/2 rounded-2xl border border-slate-800 bg-slate-900/95 p-3 shadow-2xl backdrop-blur-xl"
                  onMouseEnter={() => handleDropdownEnter(trainingTimeoutRef)}
                >
            ...
            >
              ...
              >
                ...
                <ChevronDown
                  size={15}
                  className={`transition duration-200 ${resourcesOpen ? "rotate-180 text-brand-400" : ""}`}
                />
              </button>
              ...
              {resourcesOpen && (
                <div
                  className="absolute left-1/2 top-full mt-2 w-48 -translate-x-1/2 rounded-2xl border border-slate-800 bg-slate-900/95 p-3 shadow-2xl backdrop-blur-xl"
                  onMouseEnter={() => handleDropdownEnter(resourcesTimeoutRef)}
                >
          ...
          <div className="hidden items-center justify-end gap-4 lg:flex">
            {isAuthenticated ? (
              ...
              <Link
                to="/login"
                className="btn-primary !px-5 !py-2.5 text-xs font-bold shadow-glow"
              >
          ...
          <div className="flex flex-col gap-4 rounded-3xl border border-slate-800 bg-slate-900/95 px-6 py-6 shadow-2xl backdrop-blur-xl">
            ...
            <div>
              ...
              >
                ...
                <ChevronDown
                  size={16}
                  className={`transition ${mobileServicesOpen ? "rotate-180 text-brand-400" : ""}`}
                />
              </button>
              {mobileServicesOpen && (
            ...
            <div>
              ...
              >
                ...
                <ChevronDown
                  size={16}
                  className={`transition ${mobileTrainingOpen ? "rotate-180 text-brand-400" : ""}`}
                />
              </button>
              {mobileTrainingOpen && (
                <div className="mt-2 flex flex-col gap-2.5 pl-3">
            ...
            <div>
              ...
              >
                ...
                <ChevronDown
                  size={16}
                  className={`transition ${mobileResourcesOpen ? "rotate-180 text-brand-400" : ""}`}
                />
              </button>
              {mobileResourcesOpen && (
                <div className="mt-2 flex flex-col gap-2.5 pl-3">
            ...
            {isAuthenticated ? (
              <button
                onClick={logout}
                className="text-left font-semibold text-rose-400"
              >
                Logout
              </button>
            ) : (
