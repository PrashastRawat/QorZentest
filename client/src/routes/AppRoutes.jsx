...
export default function AppRoutes() {
  return <Routes>
    <Route element={<PublicLayout/>}>
      ...
      <Route path="/training" element={<Navigate to="/training/technical" replace/>}/>
...
function NotFound() {
  return <div className="flex min-h-screen items-center justify-center"><div className="text-center"><h1 className="text-6xl font-black">404</h1><p className="mt-3 text-slate-500">Page not found.</p></div></div>;
}